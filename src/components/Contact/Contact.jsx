...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_1d5rrsg","template_loleeyt", form.current, 'PMuhvTVhW2x8ev-hU')
      .then((result) => {
          toast.success("Message sent to DevSquad");
      }, (error) => {
  ...
  return (
    <section id='contact'>
      <h5 data-aos="fade-up" data-aos-anchor="#contact"  data-aos-duration='700'>Reach to US</h5>
      <h2 data-aos="fade-up" data-aos-anchor="#contact"  data-aos-duration='900'>Contact US</h2>
      <ToastContainer/>
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option" data-aos="fade-up" data-aos-anchor=".contact__container"  data-aos-duration='1600'>
            ...
            <h4>Email</h4>
            <h5>dev.squad.business@gmail.com</h5>
            <a href="mailto:femiladiranerife24@gmail.com" target='_blank'  rel="noreferrer">Email US</a>
          </article>
          ...
          <article className="contact__option" data-aos="fade-up" data-aos-anchor=".contact__container"  data-aos-duration='1300'>
            ...
            <h4>Linkedin</h4>
            <h5>DevSquad</h5>
            <a href="#portfolio" target='_blank'  rel="noreferrer">Let's connect</a>
          </article>
